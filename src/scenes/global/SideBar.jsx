...
// import profilePic from "../../assets/349227045_822355328745997_3613876490126549095_n.jpg"
...
const SideBar = () => {
    ...
    {!isCollapsed && (
        <Box mb="25px">
            ...
            <Box textAlign="center"> 
                <Typography variant="h2" color={colors.grey[100]} fontWeight="bold" sx={{m:"10px 0 0 0"}}>Goga Imerlishvili</Typography>
    ...
    <Box paddingLeft={isCollapsed ? undefined : "10%"}>
        <Item title="Dashboard" to="/" icon={<HomeOutlinedIcon />} selected={selected}
        ...
        />
        <Item  title="Contacts Information" to="/contacts" icon={<ContactsOutlinedIcon/>} 
        selected={selected}
        setSelected={setSelected}
        />
       ...
       <Item title="Line Chart" to="/line" icon={<TimelineOutlinedIcon />}
        ...
        setSelected={setSelected}        
       />
       <Item title="Geography Chart" to="/georgraphy" icon={<MapOutlinedIcon />}
       selected={selected}
       setSelected={setSelected}
       />
    </Box>
